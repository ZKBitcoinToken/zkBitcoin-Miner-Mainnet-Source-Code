...
#   pragma warning restore 67
        ...
        protected override void UpdateMinerTimer_Elapsed(object sender, ElapsedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Program.Print(string.Format("[INFO] 1New challenge detected {0}...", miningParameters.ChallengeByte32String));
        ...
        public override event NewDifficultyEvent2 OnNewDifficulty2
        {
            add
            {
                SecondaryPool.OnNewDifficulty2 += value;
            }
        ...
        {
            var errorMessage = new StringBuilder("15[ERROR] ");
