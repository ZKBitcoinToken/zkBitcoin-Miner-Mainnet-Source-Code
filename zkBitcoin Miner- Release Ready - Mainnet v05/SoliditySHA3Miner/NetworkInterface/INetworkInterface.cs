...
namespace SoliditySHA3Miner.NetworkInterface
{
    ...
    public delegate void NewDifficultyEvent2(INetworkInterface sender, HexBigInteger difficulty2);
    ...
    public interface INetworkInterface : IDisposable
    {
        ...
        event NewDifficultyEvent2 OnNewDifficulty2;
