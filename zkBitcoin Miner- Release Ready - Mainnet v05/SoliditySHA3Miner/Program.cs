...
namespace SoliditySHA3Miner
{
    public class DevFee
    {
        ...
        public const float Percent = 5.0f;
        public const float MinimumPercent = 5.0f;
            ...
            try
            {
                ...
                else
                {
                    var web3Interface = new NetworkInterface.Web3Interface(Config.web3api, Config.contractAddress, Config.minerAddress, Config.privateKey, Config.gasToMine,
                                                                          ...
                                                                          Config.gasLimit, Config.gasApiURL, Config.gasApiPath, Config.gasApiMultiplier, Config.MaxZKBTCperMint, Config.MinZKBTCperMint, Config.HowManyBlocksAWAYFromAdjustmentToSendMinimumZKBTC, Config.gasApiOffset, Config.gasApiMax);
