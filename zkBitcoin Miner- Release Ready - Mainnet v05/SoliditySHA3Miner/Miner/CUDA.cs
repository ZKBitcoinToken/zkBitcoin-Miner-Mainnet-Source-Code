...
namespace SoliditySHA3Miner.Miner
{
    public class CUDA : MinerBase
    {
        ...
        protected override void HashPrintTimer_Elapsed(object sender, ElapsedEventArgs e)
        {
            ...
            if (zero == 0)
            {
                hashString.Append(", Normal for it to say 0.  Means we have solved the current challenge and are awaiting current reward to be greater than MinZKBTCperMint.");
            }
                ...
                unsafe
                {
                    ...
                    *solutionCount = 0;
                    do
                    {
                        ...
                        /*
                        string jsonContent = File.ReadAllText("_zkBitcoinMiner.conf"); // replace with your JSON file
                        ...
                        PrintMessage(device.Type, device.Platform, deviceCUDA.DeviceID, "Info", "fMiningTargetByte32String Difficulty: " + fMiningTargetByte32String);
