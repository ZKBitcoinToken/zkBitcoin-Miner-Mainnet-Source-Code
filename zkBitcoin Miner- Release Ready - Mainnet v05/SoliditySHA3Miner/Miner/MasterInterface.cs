...
namespace SoliditySHA3Miner.Miner
{
    public class MasterInterface : IMiner
    {
        ...
        public static class RequestMethods
        {
            ...
            public const string GetDifficulty2 = "GetDifficulty2";
        ...
        public MasterInterface(INetworkInterface networkInterface, int pauseOnFailedScans, string ipAddress = null)
        {
            ...
            NetworkInterface.OnNewTarget += NetworkInterface_OnNewTarget;
            NetworkInterface.OnNewDifficulty += NetworkInterface_OnNewDifficulty;
            NetworkInterface.OnNewDifficulty2 += NetworkInterface_OnNewDifficulty2;
            NetworkInterface.OnStopSolvingCurrentChallenge += NetworkInterface_OnStopSolvingCurrentChallenge;
            ...
            try
            {
                ...
                else
                {
                    ...
                    m_difficulty2 = Utils.Numerics.Byte32ArrayToHexString(
                        networkInterface.Difficulty2.Value.ToByteArray(isUnsigned: true, isBigEndian: true));
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            switch (jMethodName)
                            {
                                ...
                                case RequestMethods.GetDifficulty2:
                                    jResponse = GetMasterResult(m_difficulty2);
                                    break;
                                ...
                                case RequestMethods.SubmitSolution:
                                    ...
                                    var difficulty2 = Utils.Numerics.HexStringToByte32Array(jParams[3].Value<string>());
        ...
        private void NetworkInterface_OnNewDifficulty2(INetworkInterface sender, HexBigInteger difficulty2)
        {
            m_difficulty2 = Utils.Numerics.Byte32ArrayToHexString(difficulty2.Value.ToByteArray(isUnsigned: true, isBigEndian: true));
        }
